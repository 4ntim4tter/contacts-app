<div class="row">
    ...
    <div class=" col-md-6">
                    <form>
                        ...
                        <div class="row">
                            <div class="col">
                                @include('companies._company-selection')
                            </div>
                            <div class="col">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <button class="btn btn-outline-secondary" type="button" onclick="document.getElementById('search-input').value = '', document.getElementById('search-select').value = '',this.form.submit()">
