<tr>
    ...
    <td width="150">
        ...
        <form action="{{ route('contacts.forceDelete', $contact->id) }}" method="POST" onsubmit="return confirm('Your data will be removed permanently. Are you sure?')" style="display: inline">
            @csrf
            @method('delete')
